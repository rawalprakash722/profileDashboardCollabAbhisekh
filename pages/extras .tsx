				...
				<div className="d-flex flex-column flex-lg-row-auto w-xl-500px bg-lighten shadow-sm">
					...
					<div className="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-500px scroll-y">
						...
						<div className="d-flex flex-row-fluid flex-column flex-center p-10 pt-lg-20">
							{/* <!--begin::Logo--> */}
							<a href="../../demo1/dist/index.html" className="mb-10 mb-lg-20">
								...
								<div className="current" data-kt-stepper-element="content">
									...
									<div className="w-100">
										...
										<div className="pb-10 pb-lg-15">
											{/* <!--begin::Title--> */}
											<h2 className="fw-bolder d-flex align-items-center text-dark">Choose Account Type
												...
												<div className="col-lg-6">
													...
													<label className="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex align-items-center mb-10" htmlFor="kt_create_account_form_account_type_personal">
														...
														<span className="d-block fw-bold text-start">
															...
															<span className="text-muted fw-bold fs-6">If you need more info, please check it out</span>
														</span>
														{/* <!--end::Info--> */}
													</label>
													{/* <!--end::Option--> */}
												...
												<div className="col-lg-6">
													...
													<label className="btn btn-outline btn-outline-dashed btn-outline-default p-7 d-flex align-items-center" htmlFor="kt_create_account_form_account_type_corporate">
														...
														<span className="d-block fw-bold text-start">
															...
															<span className="text-muted fw-bold fs-6">Create corporate account to mane users</span>
														</span>
														{/* <!--end::Info--> */}
													</label>
													{/* <!--end::Option--> */}
								...
								<div className="" data-kt-stepper-element="content">
									...
									<div className="w-100">
										...
										<div className="mb-10 fv-row">
											{/* <!--begin::Label--> */}
											<label className="d-flex align-items-center form-label mb-3">Specify Team Size
											<i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Provide your team size to help us setup your billing"></i></label>
											{/* <!--end::Label--> */}
											{/* <!--begin::Row--> */}
											<div className="row mb-2" data-kt-buttons="true">
												...
												<div className="col">
													...
													<label className="btn btn-outline btn-outline-dashed btn-outline-default w-100 p-4 active">
														<input type="radio" className="btn-check" name="account_team_size" checked="checked" value="2-10" />
