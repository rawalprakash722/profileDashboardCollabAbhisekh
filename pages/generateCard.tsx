										...
										<div className="row mb-3 bg-white">
											...
											<div className="col-md-6 pe-lg-10 " >
												...
												<form action="" className="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="post" id="kt_contact_form">
													<h1 className="fw-bolder text-dark mb-3">Personal Information</h1>
...
<!--begin::Col Email--> */}
												...
												<div className="col-md-6 fv-row mb-5 fv-plugins-icon-container ">
														{/* <!--begin::Label--> */}
								...
								<img src="cardGG.png" alt="card "  className="rounded w-75 mb-4" style={ { boxShadow: "10px 6px 10px rgba(0,0,0,0.5)",position:"relative" }}/>
								<h6 className="mt-4 text-white text-uppercase" style={{position:"absolute",top:"17rem"}}>{addressCard} </h6>
								<h6 className="mt-4 text-white text-uppercase" style={{position:"absolute",top:"2rem"}}>{title} </h6>
								</div>

{/* why use gg card section */}
								<div className="col-md-12 fv-row fv-plugins-icon-container rounded-3" style={ { boxShadow: "10px 6px 10px rgba(0,0,0,0.5)" }}>
								...
								<img src="whyUseGG.jpg" alt="card "  className="rounded w-75 mb-4" />
